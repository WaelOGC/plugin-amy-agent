...
define( 'AMY_AGENT_VERSION', '0.2.21' );
...
require_once AMY_AGENT_PATH . 'includes/class-amy-tasks-ajax.php';
require_once AMY_AGENT_PATH . 'includes/class-amy-analytics-ajax.php';
